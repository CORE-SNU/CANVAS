...
class GridMPC:
    ...
    def __call__(self, position_x, position_y, orientation_z, boxes, predictions, confidence_intervals, goal,**__):
    ...
    def score_paths(paths, vels, goal):
        ...
        #return paths[minimum_cost], vels[minimum_cost], minimum_cost
