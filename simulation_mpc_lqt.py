...
def main(num_iter, dataset_name, predictor, predictor_base, miscoverage_level,visualize: bool = False):
    ...
    env = Environment(
        ...
        **scenario_configs[dataset_name],
        ...
        path_to_frames='/home/snowhan/CANVAS-master/assets/frames',
    ...
    for _ in range(num_iter):
        ...
        cp_params = {'target_miscoverage_level': miscoverage_level, 'step_size': .02, 'delay': prediction_horizon, 'sample_size': 3}
        ...
        fig.tight_layout()
        fig.savefig("miscoverage_level_"+str(miscoverage_level)+"dataset_"+dataset_name+'_coverage.pdf')

        plt.close()

    return
DATASET_CHOICES   = ["snu-asri", "snu-asri-ood"]
coverage = [ 0.3, 0.2,0.1,0.05]
