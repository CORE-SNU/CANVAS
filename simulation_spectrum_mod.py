...
from save_ci import save_ci_traj_positions_csv, save_ci_ctrl_local_csv, project_ctrl_step_to_local_xy, save_ci_iteration_csv, save_frame_png_spectrum_mod
...
def main(goal_x, goal_y, num_iter, r_star, dataset, predictor, video_fps, save_video):
    ...
    for times in range(num_iter):
        ...
        while not done:
            ...
            try:
                frame_png=save_frame_png_spectrum_mod(
                    outdir=iter_out_dir,
                    frame_idx=frame,
