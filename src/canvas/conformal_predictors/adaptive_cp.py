...
class AdaptiveConformalPredictionModule:
    ...
    def _update_calibration_sets(self, scores):
        ...
        for i, score in enumerate(scores):
            ...
            #print("CAL_{}: ".format(i), self._online_calibration_set[i])
        return
    ...
    def _compute_interval_lengths(self):
        ...
        for i in range(self._n_scores):
            ...
            #print("{}_th samples: ".format(i), samples)
    ...
    def _update_miscoverage_levels(self, coverages):
        if coverages.size > 0:
            ...
            #self._alpha_t = np.clip(self._alpha_t, a_min=-np.inf, a_max=1.01)
        #print("Alpha: ", self._alpha_t)
